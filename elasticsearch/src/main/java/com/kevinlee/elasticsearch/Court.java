...
public enum Court {
    ...
    LIU_XING_HUA_YUAN("流星花园三区", "流星花园三区（80-120）",80,120,""),
    ...
    LONG_HUA_YUAN84("龙华园", "龙华园（84-90）",84,90,"南 北"),
    GUO_SHI_HUI("国仕汇", "国仕汇（80-110）",80,110,"南 北"),

    JIN_KE_CHENG("金科城", "金科城（130-200）",120,130,"南 北"),
